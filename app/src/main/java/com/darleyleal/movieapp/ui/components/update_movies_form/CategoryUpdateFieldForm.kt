...
fun CategoryUpdateFieldForm(
    ...
    MovieAppTheme {
        ...
        var category by remember { mutableStateOf(movie.category.toString()) }
        movieFormViewModel.categoryUpdate = category
        ...
        TextField(
            ...
            isError = !categoryFieldIsValid || movieFormViewModel.categoryUpdate.trim().isEmpty(),
            label = {
