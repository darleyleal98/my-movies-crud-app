...
fun NameUpdateFieldForm(
    ...
    MovieAppTheme {
        ...
        var name by remember { mutableStateOf(movie.name.toString())}
        movieFormViewModel.nameUpdate = name
        ...
        TextField(
            ...
            isError = !nameFieldIsValid || movieFormViewModel.nameUpdate.trim().isEmpty(),
            label = {
